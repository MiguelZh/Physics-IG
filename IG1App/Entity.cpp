...
//-------------------------------------------------------------------------
Poliespiral::Poliespiral(const dvec2 verIni, const GLdouble angIni, const GLdouble incrAng,
                         const GLdouble ladoIni, const GLdouble incrLado, const GLuint numVert)
    : Entity() {
...
Dragon::Dragon(const GLuint numVert) : Entity() {
